        ...
        <main>
            <section class="container">
                ...
                <form @submit.prevent="login">
                    <div>
                        <input type="text" id="login" name="login" placeholder="Login" v-model="username"  :class="{ 'error-border': loginError }" required>
                    </div>
                    <div>
                        <input type="password" id="password" name="password" placeholder="Hasło" v-model="password"  :class="{ 'error-border': loginError }"
                            required>
                    </div>
